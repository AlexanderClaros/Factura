...
for numero_tabla in range(numero):
    if numero_tabla<4:
        ...
        writeString(c,138,alto,240,desc_art,titulo)
        writeString(c,330,alto,240,garantia,titulo)
        writeString(c,400-c.stringWidth(ud),alto,240,ud,titulo)
        writeString(c,445-c.stringWidth(precio),alto,240,precio,titulo)
        writeString(c,476-c.stringWidth(dto),alto,240,dto,titulo)
        writeString(c,521-c.stringWidth(neto),alto,240,neto,titulo)
        writeString(c,578-c.stringWidth(importes),alto,240,importes,titulo)
        ...
        for index,linea in enumerate(lineas_tabla_1):
            ...
            writeString(c,363-c.stringWidth(linea[2]),alto,255+(index*12.8),linea[2],7.5,'Helvetica')
            writeString(c,400-c.stringWidth(linea[3]),alto,255+(index*12.8),linea[3],7.5,'Helvetica')
            writeString(c,445-c.stringWidth(linea[4]),alto,255+(index*12.8),linea[4],7.5,'Helvetica')
            writeString(c,476-c.stringWidth(linea[5]),alto,255+(index*12.8),linea[5],7.5,'Helvetica')
            writeString(c,521-c.stringWidth(linea[6]),alto,255+(index*12.8),linea[6],7.5,'Helvetica')
            writeString(c,578-c.stringWidth(linea[7]),alto,255+(index*12.8),linea[7],7.5,'Helvetica')
        writeString(c,400-c.stringWidth(str("{:.2f}".format(total_unidades))),alto,556,str("{:.2f}".format(total_unidades)),7.5,'Helvetica-Bold')
...
if numero_tabla<4 and final==True:
    ...
    writeString(c,65,alto,643,pago + datos['FP_DENO'],6)
